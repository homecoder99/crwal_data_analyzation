...
.PHONY: install test test-verbose test-coverage test-excel test-crawler test-main test-integration test-unit test-fast lint format typecheck quality run resume analyze analyze-stats generate-test-data clean help